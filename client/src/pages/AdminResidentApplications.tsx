...
interface AdminResidentApplicationsProps {
  onLogout: () => void;
  currentUser?: string;
...
export default function AdminResidentApplications({ 
  ...
  currentUser = "admin",
  userRole = "admin"
}: AdminResidentApplicationsProps) {
  ...
  return (
    <AdminShell
      ...
      subtitle="Review and manage resident applications"
      breadcrumbs={[{ label: "Resident Applications" }]}
